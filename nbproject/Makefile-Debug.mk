...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/design_pipes.exe: ${OBJECTFILES}
	...
	${LINK.f} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/design_pipes ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/_m1messages.o: src/_m1messages.f90
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/_m1messages.o src/_m1messages.f90

${OBJECTDIR}/src/_m2metodosLineales.o: src/_m2metodosLineales.f90
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/_m2metodosLineales.o src/_m2metodosLineales.f90
...
${OBJECTDIR}/src/main.o: src/main.f90
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/main.o src/main.f90

${OBJECTDIR}/src/pTuberiaSimple.o: src/pTuberiaSimple.f90
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/pTuberiaSimple.o src/pTuberiaSimple.f90

${OBJECTDIR}/src/test.o: src/test.f90
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/test.o src/test.f90
